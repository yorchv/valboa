...
CommandBlockMorph.prototype.drawNew = function () {
    ...
    this.hasCSlot = this.hasCSlot || false;

    if (this.children.length && !this.hasCSlot) {
        for(var i = 0; i <= this.children.length; i++) {
            if (this.children[i] instanceof CSlotMorph) {
                this.hasCSlot = true;
            }
        }
    }
    ...
    if (!this.hasCSlot) {
        ...
        this.drawCSTop(context);
        this.drawCSBody(context);
        this.drawCSBottom(context);
    }
...
CommandBlockMorph.prototype.drawCSBody = function (context) {

    context.fillRect(
        2,
        Math.floor(this.corner + 2),
        this.width(),
        this.height() - Math.floor(this.corner * 3) + 1
    );
};
...
CommandBlockMorph.prototype.drawCSTop = function(context) {
    context.beginPath();
    ...
    context.lineTo(this.width(), 50);
    context.lineTo(this.width() - 30, 50);
    context.lineTo(this.width() - 30, 10);
...
CommandBlockMorph.prototype.drawCSBottom = function(context) {
...
CommandBlockMorph.prototype.drawDent = function (context, x, y) {
    ...
    // JV- Edit
    context.lineTo(x + this.corner + this.inset + 30, y);
    context.lineTo(x + this.corner + this.inset + 30, y + 3);
    context.lineTo(indent + this.dent + 50, y + 3);
    context.lineTo(x + this.corner * 2 + this.inset + this.dent + 50, y);
...
CSlotMorph.prototype.fixLayout = function () {
    ...
    this.layouInset = this.layouInset || this.inset * 8;
    this.inset = this.layouInset;
    if (nb) {
        nb.setPosition(
            new Point(
...
CSlotMorph.prototype.drawFlat = function (context) {
    ...
    // top line:
    context.moveTo(0, 0);
    context.quadraticCurveTo(0,8,20,8);
    // context.arc(
    //     30,
    //     0,
    //     20,
    ...
    context.lineTo(92, 8);
    context.lineTo(92, 8 + 5);
    context.lineTo(145, 8 + 5);
    context.lineTo(145, 8);

    context.lineTo(this.width() - 1, 8);
    ...
    context.moveTo(0, this.height() - this.corner);

    context.lineTo(this.dent * 2, this.height() - this.corner);

    context.lineTo(this.dent * 2, this.height());
    ...
    context.lineTo(this.width() - 2, this.height() + 110);
